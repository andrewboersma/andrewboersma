...
- **~4,800 concurrent agents** at peak, each in its own Kubernetes pod, handling multi-week negotiations across SMS, MMS, and voice.
- **100K+ autonomous negotiations** driving **$17M+ in customer savings**.
- Cut cost per agent negotiation from **$3+ to sub-$0.70** via token caching, inbound event batching, and context optimization.
- **~90% reduction** in repeated-reasoning token cost with a post-loop context-rebuild system.
...
> Most of my day-to-day code lives in private product repos. Happy to walk a hiring team through any of these systems in depth.
...
![LLM / Agents](https://img.shields.io/badge/LLM%20%2F%20Agents-412991?style=flat&logo=openai&logoColor=white)
